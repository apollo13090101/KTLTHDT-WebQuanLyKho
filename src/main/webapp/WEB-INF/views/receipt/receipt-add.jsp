    ...
    <div class="row">
    	<div class="col-md-12 col-sm-12">
    		<div class="x_panel">
    			...
    			<div class="x_content">
    				<br>
    				<form:form modelAttribute="modelForm" method="POST" servletRelativeAction="/receipt/add"  cssClass="form-horizontal form-label-left">
...
<script type="text/javascript">
	$(document).ready(
		function () {
			$('#receiptlistId').addClass('cuurent-page').siblings().removeClass('current-page');
			var parent = $('#receiptlistId').parents('li');
			parent.addClass('active').siblings().removeClass('active');
			$('#receiptlistId').parents().show();
		}		
	);
	
	function cancel() {
		window.location.href = '<c:url value="/receipt/list"/>'
	}
</script>