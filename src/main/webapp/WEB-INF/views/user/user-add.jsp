    ...
    <div class="row">
    	<div class="col-md-12 col-sm-12">
    		<div class="x_panel">
    			...
    			<div class="x_content">
    				<br>
    				<form:form modelAttribute="modelForm" method="POST" servletRelativeAction="/user/add"  cssClass="form-horizontal form-label-left">
    					<form:hidden path="id"/>    					
    					...
    					<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12"> 
								...
								<form:input path="password" disabled="${viewOnly }" cssClass="form-control" />
							</div>
						</div>
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12"> 
								...
								<form:input path="email" disabled="${viewOnly }" type="email" cssClass="form-control" />
							</div>
						</div>
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12"> 
								...
								<form:input path="salary" disabled="${viewOnly }" value="4000000" cssClass="form-control" />
							</div>
						</div>
