    		...
    		<div class="x_panel">
    			...
    			<div class="x_content">
    				...
    				<form:form modelAttribute="modelForm" method="GET" cssClass="form-horizontal form-label-left">
    					...
    					<div class="item form-group">
							<label class="col-form-label col-md-3 col-sm-3 label-align" for="unit">Unit
							</label>
							<div class="col-md-6 col-sm-6 col-xs-12"> 
						...
						<div class="item form-group">
							<label class="col-form-label col-md-3 col-sm-3 label-align" for="product.category.name">Category
							</label>
							<div class="col-md-6 col-sm-6 col-xs-12"> 
								<form:input path="category.name" disabled="${viewOnly }" cssClass="form-control" />
							</div>
						</div>
