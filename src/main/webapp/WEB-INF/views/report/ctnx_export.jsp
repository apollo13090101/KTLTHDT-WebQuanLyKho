...
try 
{
    ...
    String jrxmlFile ="F:/BG Ky Thuat Lap Trinh HDT/Final/eclipse-workspace/INT14103//src/main/webapp/WEB-INF/views/report/ctnx.jrxml";
	...
	if (type.equalsIgnoreCase("IMPORT")) {
		map.put("REPORT_TITLE", "Detail of Import");
	} else if (type.equalsIgnoreCase("EXPORT")) {
		map.put("REPORT_TITLE", "Detail of Export");
	}

	map.put("NGAYBD", ngaybd);
