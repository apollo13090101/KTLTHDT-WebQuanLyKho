    	...
    	<div class="col-md-12 col-sm-12">
    		<div class="x_panel">
    			...
    			<div class="x_content">
    				...
    				<div class="container">
    					<form action="/INT14103/ctnx/export" target="_blank" method="POST" > 
...
<script type="text/javascript">
	...
	function confirmDelete(code) {
		if (confirm('Are you sure you want delete this ctnx?')) {
			window.location.href = '<c:url value="/ctnx/delete/"/>' + code;
		}
	};
	
	function gotoPage(page) {
		$('#searchForm').attr('action', '<c:url value="/ctnx/list/"/>' + page);
		$('#searchForm').submit();
	};
