    	...
    	<div class="col-md-12 col-sm-12">
    		<div class="x_panel">
    			...
    			<div class="x_content">
    				...
    				<div class="container">
    					<form action="/INT14103/ddhkpn/export" target="_blank" method="POST" > 
...
<script type="text/javascript">
	...
	function confirmDelete(code) {
		if (confirm('Are you sure you want delete this ddh?')) {
			window.location.href = '<c:url value="/ddh/delete/"/>' + code;
		}
	};
	
	function gotoPage(page) {
		$('#searchForm').attr('action', '<c:url value="/ddh/list/"/>' + page);
		$('#searchForm').submit();
	};
