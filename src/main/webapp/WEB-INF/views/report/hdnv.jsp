    	...
    	<div class="col-md-12 col-sm-12">
    		<div class="x_panel">
    			...
    			<div class="x_content">
    				...
    				<div class="container">
    					<form action="/INT14103/hdnv/export" target="_blank" method="POST" > 
    						...
    						<div class="row">
    							...
    							<div class="col-xs-12 col-sm-6 col-md-6">
	    							<label for="ngaybd">User</label>
	    							<div class="form-group">
										<div class="form-group">
	    								<input type="number" name="MANV" id="manv" class="form-control" placeholder="Enter ID. Ex: 1, 2, 3,..." required />
	    							</div>
	    							</div>
    							</div>
...
<script type="text/javascript">
	...
	function confirmDelete(code) {
		if (confirm('Are you sure you want delete this hdnv?')) {
			window.location.href = '<c:url value="/hdnv/delete/"/>' + code;
		}
	};
	
	function gotoPage(page) {
		$('#searchForm').attr('action', '<c:url value="/hdnv/list/"/>' + page);
		$('#searchForm').submit();
	};
